...
export default function Home() {
  ...
  return (
    <div className="bg-brand-bg text-aura-text selection:bg-aura-text/20 selection:text-aura-text antialiased overflow-x-hidden min-h-screen relative transition-colors duration-500">
      <AuraNav />
      ...
      <div className="fixed inset-0 z-0 pointer-events-none flex justify-center select-none">
        <div className="w-full max-w-[1400px] h-full border-x border-aura-border/30 grid grid-cols-4 relative">
          <div className="border-r border-aura-border/30 h-full hidden md:block relative">
            <div className="absolute top-0 right-0 w-[1px] h-32 bg-gradient-to-b from-transparent via-aura-text/20 to-transparent animate-[dataStream_3s_linear_infinite]"></div>
          </div>
          <div className="border-r border-aura-border/30 h-full hidden md:block relative">
            <div className="absolute top-[20%] right-0 w-[1px] h-32 bg-gradient-to-b from-transparent via-aura-text/20 to-transparent animate-[dataStream_4s_linear_infinite_1s]"></div>
          </div>
          <div className="border-r border-aura-border/30 h-full hidden md:block relative">
            <div className="absolute top-[60%] right-0 w-[1px] h-32 bg-gradient-to-b from-transparent via-aura-text/20 to-transparent animate-[dataStream_2.5s_linear_infinite_0.5s]"></div>
          </div>
        </div>
      </div>
