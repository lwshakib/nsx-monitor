    ...
    <section className="aura-section z-10 pt-32 pb-32 overflow-hidden" id="capabilities">
      <div className="aura-container border-t border-white/5 pt-20">
        ...
        <div className="flex items-center gap-6 mb-20 px-6 md:px-10 fade-up">
          <h2 className="text-[10px] font-mono tracking-[0.3em] font-bold uppercase text-aura-text">
            Core Primitives
          </h2>
          <div className="h-px bg-aura-border flex-1"></div>
          <span className="text-[9px] font-mono text-aura-text-muted tracking-widest">
            SYS_CAPABILITIES
          </span>
        </div>
          ...
          <div className="relative group fade-up h-full" style={{ perspective: '1200px' }}>
            <div className="w-full h-full relative transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:[transform:rotateX(10deg)_rotateY(-10deg)]" style={{ transformStyle: 'preserve-3d' }}>
              ...
              <div className="relative p-10 rounded-3xl bg-aura-bg border border-aura-border overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:border-aura-border-bright group-hover:shadow-[-30px_30px_50px_rgba(0,0,0,0.4)] group-hover:bg-brand-surface z-10 h-full flex flex-col group-hover:[transform:translateZ(20px)]">
                <div className="absolute top-0 right-0 w-32 h-32 bg-aura-border-bright rounded-full blur-[50px] pointer-events-none group-hover:bg-aura-border transition-colors"></div>
                <div className="flex justify-between items-start mb-8">
                  <div className="w-12 h-12 rounded-xl bg-aura-bg border border-aura-border flex items-center justify-center group-hover:scale-110 transition-transform duration-500 shadow-inner">
                    <Icon icon="solar:box-minimalistic-linear" className="text-2xl text-aura-text-muted group-hover:text-aura-text" />
                  </div>
                ...
                <div className="flex items-center gap-2 mt-auto">
                  <div className="flex-1 h-[2px] bg-aura-border relative overflow-hidden">
                    <div className="absolute top-0 left-0 h-full w-1/3 bg-aura-text animate-[shimmerLine_2s_linear_infinite]"></div>
                  </div>
                  <span className="text-[10px] font-mono text-aura-text-muted uppercase">Active</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="w-full h-full relative transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:[transform:rotateX(10deg)_rotateY(-10deg)]" style={{ transformStyle: 'preserve-3d' }}>
              <div className="absolute inset-0 rounded-3xl bg-brand-bg border border-aura-border transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:[transform:translate3d(40px,-40px,-80px)] opacity-0 group-hover:opacity-100 flex flex-col justify-start p-6 overflow-hidden shadow-2xl">
                ...
                <div className="flex items-end gap-1.5 mt-3 h-4">
                  <div className="h-2 w-1.5 bg-aura-border-bright rounded-sm"></div>
                  <div className="h-4 w-1.5 bg-aura-text-muted rounded-sm"></div>
                  <div className="h-3 w-1.5 bg-aura-border-bright rounded-sm"></div>
                  <div className="h-2 w-1.5 bg-aura-border-bright rounded-sm"></div>
                </div>
              </div>
              ...
              <div className="relative p-10 rounded-3xl bg-aura-bg border border-aura-border overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:border-aura-border-bright group-hover:shadow-[-30px_30px_50px_rgba(0,0,0,0.4)] group-hover:bg-brand-surface z-10 h-full flex flex-col group-hover:[transform:translateZ(20px)]">
                ...
                <div className="flex justify-between items-start mb-8 relative z-10">
                  <div className="w-12 h-12 rounded-xl bg-aura-bg border border-aura-border flex items-center justify-center group-hover:scale-110 transition-transform duration-500 shadow-inner">
                    <Icon icon="solar:cpu-bolt-linear" className="text-2xl text-aura-text-muted group-hover:text-aura-text" />
                  </div>
                  <div className="text-[9px] font-mono text-aura-text-muted border border-aura-border px-2 py-1 rounded bg-brand-surface flex items-center gap-1">
                    <div className="w-1 h-1 bg-aura-text rounded-full animate-pulse"></div>
                    MOD_02
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1 mt-auto relative z-10">
                  ...
                  <div className="h-4 w-1 bg-aura-border-bright group-hover:bg-aura-text anim-bar-2 transition-colors"></div>
                  <div className="h-2 w-1 bg-aura-border-bright group-hover:bg-aura-text anim-bar-3 transition-colors"></div>
                  <div className="h-5 w-1 bg-aura-border-bright group-hover:bg-aura-text anim-bar-4 transition-colors"></div>
                  <div className="h-3 w-1 bg-aura-border-bright group-hover:bg-aura-text anim-bar-5 transition-colors"></div>
                  <span className="text-[10px] font-mono text-aura-text-muted uppercase ml-2">Processing</span>
                </div>
              </div>
            </div>
          </div>
