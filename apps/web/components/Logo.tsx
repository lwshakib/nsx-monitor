...
const Logo: React.FC<LogoProps> = ({ className }) => {
  return (
    <Link
      to="/"
      className={`flex items-center gap-2.5 transition-opacity hover:opacity-90 active:scale-95 ${className}`}
    >
      <svg
        width="36"
        height="36"
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              mode="normal"
              in2="shape"
              result="effect1_innerShadow_467_3284"
            />
          </filter>
          <linearGradient
      ...
      <span className="text-ui-text text-xl font-bold tracking-tighter">
        NSX Monitor
      </span>
    </Link>
  )
