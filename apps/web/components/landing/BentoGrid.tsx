...
const BentoGrid: React.FC = () => {
  return (
    <section className="ui-section z-10 py-32 overflow-hidden" id="topology">
      <div className="ui-container border-t border-ui-border pt-20">
        ...
        <div className="flex flex-col items-start mb-16 px-6 md:px-10 fade-up">
          <h2 className="text-3xl md:text-5xl font-normal tracking-tight mb-4 text-ui-text">
            Network Intelligence
          </h2>
          <p className="text-sm md:text-base text-ui-text-muted max-w-xl font-light leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[300px] px-6 md:px-10 fade-up">
          {/* Main Graph Box */}
          <div className="col-span-1 md:col-span-2 row-span-2 p-8 rounded-[2.5rem] bg-ui-bg border border-ui-border relative overflow-hidden group hover:border-ui-border-bright transition-all duration-500">
            ...
            <div className="h-full flex flex-col justify-between relative z-10">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[250px] h-32 flex items-end justify-between gap-1">
                <div className="w-full bg-ui-border-bright border border-ui-border relative overflow-hidden anim-bar-1">
                  <div className="absolute top-0 inset-x-0 h-[1px] bg-ui-text shadow-[0_0_10px_var(--ui-text)]"></div>
                </div>
                <div className="w-full bg-ui-border-bright border border-ui-border relative overflow-hidden anim-bar-2">
                  <div className="absolute top-0 inset-x-0 h-[1px] bg-ui-text shadow-[0_0_10px_var(--ui-text)]"></div>
                </div>
                <div className="w-full bg-ui-text border border-ui-text relative overflow-hidden anim-bar-3 shadow-[0_0_20px_var(--accent-glow)]"></div>
                <div className="w-full bg-ui-border-bright border border-ui-border relative overflow-hidden anim-bar-4">
                  <div className="absolute top-0 inset-x-0 h-[1px] bg-ui-text shadow-[0_0_10px_var(--ui-text)]"></div>
                </div>
                <div className="w-full bg-ui-border-bright border border-ui-border relative overflow-hidden anim-bar-5">
                  <div className="absolute top-0 inset-x-0 h-[1px] bg-ui-text shadow-[0_0_10px_var(--ui-text)]"></div>
                </div>
                <div className="w-full bg-ui-border-bright border border-ui-border relative overflow-hidden anim-bar-1">
                  <div className="absolute top-0 inset-x-0 h-[1px] bg-ui-text shadow-[0_0_10px_var(--ui-text)]"></div>
              ...
              <div className="">
                <h3 className="text-xl font-semibold mb-2 tracking-tight text-ui-text group-hover:translate-x-1 transition-transform">
          ...
          <div className="col-span-1 md:col-span-1 row-span-2 p-8 rounded-[2.5rem] bg-ui-bg border border-ui-border relative overflow-hidden group hover:border-ui-border-bright transition-all duration-500 flex flex-col justify-between">
            ...
            <div className="relative w-full h-40 flex flex-col items-center justify-center my-auto">
              <div className="w-24 h-24 border border-ui-border-bright bg-ui-bg-alt/80 backdrop-blur-md absolute layer-float-1 flex items-center justify-center text-[10px] font-mono text-ui-text/50 transition-colors">L3</div>
              <div className="w-24 h-24 border border-ui-border bg-brand-surface absolute layer-float-2 mt-8 flex items-center justify-center text-[10px] font-mono text-ui-text/30 transition-colors">L2</div>
              <div className="w-24 h-24 border border-ui-border bg-brand-surface/50 absolute layer-float-3 mt-16 flex items-center justify-center text-[10px] font-mono text-ui-text/10 transition-colors">L1</div>
            </div>
          ...
          <div className="col-span-1 row-span-1 p-6 rounded-[2rem] bg-ui-bg border border-ui-border relative overflow-hidden group hover:border-ui-border-bright transition-all duration-500 flex flex-col justify-between">
            <div className="flex justify-between items-start">
              ...
              <div className="w-2 h-2 rounded-full bg-ui-text animate-pulse shadow-[0_0_10px_var(--ui-text)]"></div>
            </div>
            <div>
          ...
          <div className="col-span-1 row-span-1 p-6 rounded-[2rem] bg-ui-bg border border-ui-border relative overflow-hidden group hover:border-ui-border-bright transition-all duration-500 flex flex-col justify-between">
            ...
            <div className="relative w-full h-12 border-b border-ui-border mb-2 overflow-hidden">
          ...
          {/* Wide Bottom Box */}
          <div className="col-span-1 md:col-span-4 row-span-1 p-8 rounded-[2rem] bg-ui-bg border border-ui-border relative overflow-hidden group hover:border-ui-border-bright transition-all duration-500 flex flex-col md:flex-row gap-8 items-center justify-between">
            <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-ui-border to-transparent pointer-events-none group-hover:from-ui-border-bright transition-colors"></div>
